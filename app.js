...
if ('serviceWorker' in navigator) {
  ...
  // (asagida ea2a17501a yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=ea2a17501a', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
