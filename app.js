...
if ('serviceWorker' in navigator) {
  ...
  // (asagida c7c7ae80f6 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=c7c7ae80f6', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
