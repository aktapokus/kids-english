...
if ('serviceWorker' in navigator) {
  ...
  // (asagida b1f18b8e8f yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=b1f18b8e8f', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
