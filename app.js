...
if ('serviceWorker' in navigator) {
  ...
  // (asagida acff82701f yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=acff82701f', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
