...
if ('serviceWorker' in navigator) {
  ...
  // (asagida b1cec09232 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=b1cec09232', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
