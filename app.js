...
if ('serviceWorker' in navigator) {
  ...
  // (asagida d10b4fb297 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=d10b4fb297', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
