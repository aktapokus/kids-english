...
if ('serviceWorker' in navigator) {
  ...
  // (asagida f41de9a801 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=f41de9a801', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
