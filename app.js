...
if ('serviceWorker' in navigator) {
  ...
  // (asagida a4104c4ae5 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=a4104c4ae5', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
