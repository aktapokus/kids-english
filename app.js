...
if ('serviceWorker' in navigator) {
  ...
  // (asagida e1dd145955 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=e1dd145955', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
