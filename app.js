...
if ('serviceWorker' in navigator) {
  ...
  // (asagida becb42a72b yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=becb42a72b', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
