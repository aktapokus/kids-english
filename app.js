...
if ('serviceWorker' in navigator) {
  ...
  // (asagida eb71430eeb yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=eb71430eeb', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
