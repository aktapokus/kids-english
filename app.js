...
if ('serviceWorker' in navigator) {
  ...
  // (asagida a2a3573cbf yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=a2a3573cbf', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
