...
if ('serviceWorker' in navigator) {
  ...
  // (asagida d6a311ab28 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=d6a311ab28', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
