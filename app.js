...
if ('serviceWorker' in navigator) {
  ...
  // (asagida df85eb7ea0 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=df85eb7ea0', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
