...
if ('serviceWorker' in navigator) {
  ...
  // (asagida c1d9998593 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=c1d9998593', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
