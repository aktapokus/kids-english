...
if ('serviceWorker' in navigator) {
  ...
  // (asagida e242422fe1 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=e242422fe1', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
