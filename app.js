...
if ('serviceWorker' in navigator) {
  ...
  // (asagida 06024d7cc1 yer tutucusu, build_pwa.py build hash'iyle
  ...
  navigator.serviceWorker.register('sw.js?v=06024d7cc1', { updateViaCache: 'none' }).then((reg) => {
    reg.update().catch(() => {});
